...
export const getMsrAmount = (config) => {
    return http.get('volume/msrAmount', config);
}
...
export const getVolumes = (config) => {
    return http.get('volume/volumes', config);
}
...
export const getDoorAddr = (config) => {
    return http.get('volume/doorAddr', config);
}
...
export const getShopAddr = (config) => {
    return http.get('volume/shopAddr', config);
}
...
export const getVolumeTime = (config) => {
    return http.get('volume/volumeTime', config);
}
...
export const getVolumeList = (config) => {
    return http.get('volume/volumeList', config);
}
