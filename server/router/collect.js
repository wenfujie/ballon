...
const collectModule = require('../controller/collect')
...
module.exports = {
    ...
    "POST/addCollection": collectModule.addCollection,
    "POST/batchCollection": collectModule.batchCollection,
    // "POST/addCollectionComb": addCollectionComb,
    "DELETE/deleteCollection": collectModule.deleteCollection,
