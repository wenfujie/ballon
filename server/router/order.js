...
const orderService = require("../controller/order");
...
module.exports = {
    ...
    "GET/reasonList": orderService.getReasonList,  // 获取退单理由列表
    "GET/orderNum": orderService.getorderNum,  // 获取用户不同状态订单对应的数量
    "POST/buyAgain": orderService.buyAgain, //再次购买
    "GET/clearCache": orderService.clearCache, //再次购买
    "GET/clearAllCache": orderService.clearAllCache //再次购买
};
